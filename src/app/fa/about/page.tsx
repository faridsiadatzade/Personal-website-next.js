...
const aboutData: AboutInfo = {
  ...
  description: [
    "من یک توسعه دهنده فرانت‌اند با بیش از ۵ سال تجربه در ایجاد وب اپلیکیشن‌های مدرن و ریسپانسیو هستم. سفر من در توسعه وب با کنجکاوی درباره نحوه کار وب‌سایت‌ها آغاز شد و به علاقه به ایجاد رابط‌های کاربری زیبا و کاربرپسند تبدیل شد.",
    "من در React و TypeScript تخصص دارم، با تمرکز قوی بر ساخت برنامه‌های مقیاس‌پذیر و قابل نگهداری. به ویژه به یادگیری مداوم و به‌روز نگه‌داشتن دانش فنی خود باور دارم.",
  ],
  personalInfo: {
    "نام": "فرید سیادت زاده",
    "سن": "۲۸",
  ...
  services: [
    ...
    {
      title: "طراحی UI/UX",
      description: "ایجاد رابط‌های کاربری بدیهی و زیبا با تمرکز بر تجربه کاربری موفق.",
      icon: "🎨"
    },
    {
      title: "بررسی کد",
      description: "ارائه بررسی‌های دقیق کد برای اطمینان از کد با کیفیت بالا و قابل نگهداری.",
      icon: "📝"
    },
    {
